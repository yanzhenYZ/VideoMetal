...
NSString *const kT3GPUImageBeautyFragmentShaderString = SHADER_STRING
                                                        (
...
@implementation T3GPUImageBeautyFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kT3GPUImageBeautyFragmentShaderString])) {
        return nil;
    }
