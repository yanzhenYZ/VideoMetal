#import "T3GPUImageUIElement.h"

@interface T3GPUImageUIElement ()
{
    UIView *view;
    CALayer *layer;
...
@implementation T3GPUImageUIElement
...
//    CGContextRotateCTM(imageContext, M_PI_2);
    ...
    outputFramebuffer = [[T3GPUImageContext sharedFramebufferCache] fetchFramebufferForSize:layerPixelSize textureOptions:self.outputTextureOptions onlyTexture:YES];
