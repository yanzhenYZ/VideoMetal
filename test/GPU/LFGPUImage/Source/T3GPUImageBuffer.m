#import "T3GPUImageBuffer.h"

@interface T3GPUImageBuffer()

@end

@implementation T3GPUImageBuffer
...
- (void)dealloc
{
    for (T3GPUImageFramebuffer *currentFramebuffer in bufferedFramebuffers)
    {
...
- (void)setBufferSize:(NSUInteger)newValue;
{
    ...
    else
    {
        ...
        {
            T3GPUImageFramebuffer *lastFramebuffer = [bufferedFramebuffers lastObject];
