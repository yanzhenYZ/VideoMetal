...
#import "T3GPUImagePicture.h"
#import <AVFoundation/AVFoundation.h>

// Hardcode the vertex shader for standard filters, but this can be overridden
NSString *const kT3GPUImageVertexShaderString = SHADER_STRING
(
...
NSString *const kT3GPUImagePassthroughFragmentShaderString = SHADER_STRING
(
...
@implementation T3GPUImageFilter
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation = kT3GPUImageNoRotation;
    ...
    T3runSynchronouslyOnVideoProcessingQueue(^{
        ...
        filterProgram = [[T3GPUImageContext sharedImageProcessingContext] programForVertexShaderString:vertexShaderString fragmentShaderString:fragmentShaderString];
...
{
    if (!(self = [self initWithVertexShaderFromString:kT3GPUImageVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)init;
{
    if (!(self = [self initWithFragmentShaderFromString:kT3GPUImagePassthroughFragmentShaderString]))
    {
		return nil;
    }
...
- (CGImageRef)newCGImageFromCurrentlyProcessedOutput
{
    ...
    T3GPUImageFramebuffer* framebuffer = [self framebufferForOutput];
...
+ (const GLfloat *)textureCoordinatesForRotation:(T3GPUImageRotationMode)rotationMode;
{
    ...
    switch(rotationMode)
    {
        case kT3GPUImageNoRotation: return noRotationTextureCoordinates;
        case kT3GPUImageRotateLeft: return rotateLeftTextureCoordinates;
        case kT3GPUImageRotateRight: return rotateRightTextureCoordinates;
        case kT3GPUImageFlipVertical: return verticalFlipTextureCoordinates;
        case kT3GPUImageFlipHorizonal: return horizontalFlipTextureCoordinates;
        case kT3GPUImageRotateRightFlipVertical: return rotateRightVerticalFlipTextureCoordinates;
        case kT3GPUImageRotateRightFlipHorizontal: return rotateRightHorizontalFlipTextureCoordinates;
        case kT3GPUImageRotate180: return rotate180TextureCoordinates;
    }
}
...
- (void)setMatrix3f:(LFGPUMatrix3x3)matrix forUniform:(GLint)uniform program:(T3GLProgram *)shaderProgram;
{
    T3runAsynchronouslyOnVideoProcessingQueue(^{
        [T3GPUImageContext setActiveShaderProgram:shaderProgram];
...
- (CGPoint)rotatedPoint:(CGPoint)pointToRotate forRotation:(T3GPUImageRotationMode)rotation;
{
    ...
    switch(rotation)
    {
        case kT3GPUImageNoRotation: return pointToRotate; break;
        case kT3GPUImageFlipHorizonal:
        {
            rotatedPoint.x = 1.0 - pointToRotate.x;
            rotatedPoint.y = pointToRotate.y;
        }; break;
        case kT3GPUImageFlipVertical:
        {
            rotatedPoint.x = pointToRotate.x;
            rotatedPoint.y = 1.0 - pointToRotate.y;
        }; break;
        case kT3GPUImageRotateLeft:
        {
            rotatedPoint.x = 1.0 - pointToRotate.y;
            rotatedPoint.y = pointToRotate.x;
        }; break;
        case kT3GPUImageRotateRight:
        {
            rotatedPoint.x = pointToRotate.y;
            rotatedPoint.y = 1.0 - pointToRotate.x;
        }; break;
        case kT3GPUImageRotateRightFlipVertical:
        {
            rotatedPoint.x = pointToRotate.y;
            rotatedPoint.y = pointToRotate.x;
        }; break;
        case kT3GPUImageRotateRightFlipHorizontal:
        {
            rotatedPoint.x = 1.0 - pointToRotate.y;
            rotatedPoint.y = 1.0 - pointToRotate.x;
        }; break;
        case kT3GPUImageRotate180:
        {
            rotatedPoint.x = 1.0 - pointToRotate.x;
            rotatedPoint.y = 1.0 - pointToRotate.y;
        }; break;
