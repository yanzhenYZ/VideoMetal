...
NSString *const kT3GPUImageTwoInputTextureVertexShaderString = SHADER_STRING
(
...
@implementation T3GPUImageTwoInputFilter
...
{
    if (!(self = [self initWithVertexShaderFromString:kT3GPUImageTwoInputTextureVertexShaderString fragmentShaderFromString:fragmentShaderString]))
    {
		return nil;
    }
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    inputRotation2 = kT3GPUImageNoRotation;
...
- (CGSize)rotatedSize:(CGSize)sizeToRotate forIndex:(NSInteger)textureIndex;
{
    ...
    T3GPUImageRotationMode rotationToCheck;
    if (textureIndex == 0)
    {
