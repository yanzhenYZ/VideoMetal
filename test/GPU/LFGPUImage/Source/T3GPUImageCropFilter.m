#import "T3GPUImageCropFilter.h"

#if TARGET_IPHONE_SIMULATOR || TARGET_OS_IPHONE
NSString *const kT3GPUImageCropFragmentShaderString =  SHADER_STRING
(
...
@interface T3GPUImageCropFilter ()
...
@implementation T3GPUImageCropFilter
...
{
    if (!(self = [super initWithFragmentShaderFromString:kT3GPUImageCropFragmentShaderString]))
    {
        return nil;
    }
...
- (void)calculateCropTextureCoordinates;
{
    ...
    {
        case kT3GPUImageNoRotation: // Works
        {
        ...
        case kT3GPUImageRotateLeft: // Fixed
        {
        ...
        case kT3GPUImageRotateRight: // Fixed
        {
        ...
        case kT3GPUImageFlipVertical: // Works for me
        {
        ...
        case kT3GPUImageFlipHorizonal: // Works for me
        {
        ...
        case kT3GPUImageRotate180: // Fixed
        {
        ...
        case kT3GPUImageRotateRightFlipVertical: // Fixed
        {
        ...
        case kT3GPUImageRotateRightFlipHorizontal: // Fixed
        {
