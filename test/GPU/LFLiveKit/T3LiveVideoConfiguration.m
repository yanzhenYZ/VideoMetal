...
@implementation T3LiveVideoConfiguration

#pragma mark -- LifeCycle

+ (instancetype)defaultConfiguration {
    T3LiveVideoConfiguration *configuration = [T3LiveVideoConfiguration defaultConfigurationForQuality:T3LiveVideoQuality_Default];
    return configuration;
}

+ (instancetype)defaultConfigurationForQuality:(T3LiveVideoQuality)videoQuality {
    T3LiveVideoConfiguration *configuration = [T3LiveVideoConfiguration defaultConfigurationForQuality:videoQuality outputImageOrientation:UIInterfaceOrientationPortrait];
    return configuration;
}
...
+ (instancetype)defaultConfigurationForQuality:(T3LiveVideoQuality)videoQuality outputImageOrientation:(UIInterfaceOrientation)outputImageOrientation {
    T3LiveVideoConfiguration *configuration = [T3LiveVideoConfiguration new];
    switch (videoQuality) {
    case T3LiveVideoQuality_Low1:{
    ...
    case T3LiveVideoQuality_Low3: {
        ...
        break;
    case T3LiveVideoQuality_Medium1:{
        ...
        break;
    case T3LiveVideoQuality_Medium2:{
        configuration.sessionPreset = LFCaptureSessionPreset540x960;
        configuration.videoFrameRate = 24;
        configuration.videoMaxFrameRate = 24;
        configuration.videoMinFrameRate = 12;
        ...
        break;
    case T3LiveVideoQuality_Medium3:{
        configuration.sessionPreset = LFCaptureSessionPreset540x960;
        configuration.videoFrameRate = 30;
        configuration.videoMaxFrameRate = 30;
        configuration.videoMinFrameRate = 15;
    ...
    configuration.devPos = AVCaptureDevicePositionFront;
    ...
    configuration.imageFillMode = kT3GPUImageFillModePreserveAspectRatioAndFill;
    return configuration;
}
...
- (void)setSessionPreset:(T3LiveVideoSessionPreset)sessionPreset{
    _sessionPreset = sessionPreset;
    _sessionPreset = [self supportSessionPreset:sessionPreset];
}

#pragma mark -- Custom Method
- (T3LiveVideoSessionPreset)supportSessionPreset:(T3LiveVideoSessionPreset)sessionPreset {
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:@(self.devPos) forKey:@"devPos"];
}
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    _devPos = [[aDecoder decodeObjectForKey:@"devPos"] unsignedIntegerValue];
    return self;
}
...
- (BOOL)isEqual:(id)other {
    if (other == self) {
        ...
        T3LiveVideoConfiguration *object = other;
        return CGSizeEqualToSize(object.videoSize, self.videoSize) &&
               ...
               object.devPos == self.devPos;
    }
}

- (id)copyWithZone:(nullable NSZone *)zone {
    T3LiveVideoConfiguration *other = [self.class defaultConfiguration];
    return other;
}

- (NSString *)description {
    NSMutableString *desc = @"".mutableCopy;
    [desc appendFormat:@"<T3LiveVideoConfiguration: %p>", self];
    ...
    [desc appendFormat:@" devPos:%zi", self.devPos];
    return desc;
}
